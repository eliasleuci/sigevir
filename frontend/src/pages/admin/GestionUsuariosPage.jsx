  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
        <div>
          <h3 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Gestión de Usuarios</h3>
          <p className="text-xs md:text-sm text-gray-500 font-medium">Administrá los usuarios del sistema SIGEVIR</p>
        </div>
